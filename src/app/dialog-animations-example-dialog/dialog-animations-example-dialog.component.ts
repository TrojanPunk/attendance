...
export class DialogAnimationsExampleDialogComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<DialogAnimationsExampleDialogComponent>, private studentDataService: StudentDataService) { }
